...
const FriendInfo = ({user ,profile, UserSelceted}) => {
  ...
  const handleUnfriend = async (userid : number) => {
    try {
      const resp = await axios.post(`${import.meta.env.VITE_url_back}/api/friends/unfriend`, {id: userid}, {withCredentials:true});
      UserSelceted(null);
        ...
        ? (<>
            ...
            <div className="other-options">
              ...
              <div className="friend-options">
                ...
                <div className="opt play-option" onClick={()=>{console.log("TESTTTTTTTTTTT");}}>
